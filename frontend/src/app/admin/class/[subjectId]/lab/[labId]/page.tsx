...
import { Users, CheckCircle, XCircle, Clock, File } from "lucide-react"; // Import icons
...
const mockLab: Lab = {
	id: "labId",
	description:
		"Analyze the given circuit and submit your report.  Include all calculations and diagrams.",
	...
	students: [
		...
		},
		{
			...
			submissionTime: new Date(),
			grade: 98,
			file: "final_submission.pdf",
		},
		{ id: "s7", name: "Grace Taylor", submitted: false },
	],
	instructionFile: {
		name: "lab_instructions.pdf",
		url: "placeholder-url/lab_instructions.pdf",
	},
	additionalFiles: [
...
export default function LabPage() {
	...
	useEffect(() => {
		fetchLabInfo(labId).then((fetchedLab) => {
